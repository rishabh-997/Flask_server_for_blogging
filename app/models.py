...
# Any users that were in the database are still there,
# the migration framework surgically applies the changes in the migration script without destroying any data.
# https://blog.miguelgrinberg.com/post/the-flask-mega-tutorial-part-viii-followers  to know more about mapping
